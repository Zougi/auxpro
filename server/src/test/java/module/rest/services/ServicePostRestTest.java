...
public class ServicePostRestTest extends RestTestBase {
	...
	public void testV_asAdmin() throws Exception {
		ServiceBean response = prepare("", userAdmin.getName(), userAdmin.getPassword()).post(Entity.entity(Mappers.DEFAULT.getMapper().writeValueAsString(bean), MediaType.APPLICATION_JSON), ServiceBean.class);
