...
public class AuxiliaryPostRestTest extends RestTestBase {
	...
	public void testV_asAdmin() throws Exception {
		AuxiliaryBean response = prepare("", accountAdmin.getUser()).post(Entity.entity(Mappers.DEFAULT.getMapper().writeValueAsString(bean), MediaType.APPLICATION_JSON), AuxiliaryBean.class);
